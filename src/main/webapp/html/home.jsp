            ...
            <div class="nav-collapse">
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul id="userDropDown" class="dropdown-menu">
                        <li><a id="switchUserBtn" href="/logout">切换用户</a></li>
                        <li class="divider"></li>
    ...
    <div class="well sidebar-nav">
        <ul class="nav nav-list">
            ...
            <shiro:hasRole name="admin">
                ...
                <li id="ammeterMonitorItemBtn"><a id="ammeterMonitorItem" href="#">抄表设置</a></li>
...
<div id="ammeterRecordPane" data-dojo-type="dijit.layout.ContentPane" title="电表纪录管理">
    <div id="ar_grid_container" style="width: 100%;" class="claro">
        <div>
            <button id="startMoniter" style="margin-left:1em;" data-dojo-type="dijit.form.Button">
                开始抄表
            </button>
            <button id="refreshRecord" style="margin-left:1em;" data-dojo-type="dijit.form.Button">
                刷新数据
            </button>
        </div>
        <br/>
...
<div id="ammeterMonitorPane" data-dojo-type="dijit.layout.ContentPane" title="抄表设置" style="overflow:auto;">
    <!-- The Data Grid -->
    <br>

    <div id="ammeterMonitorGrid" class="claro" style="height:400px; margin-top:2em;"></div>
    <!-- The Action Bar -->
</div>
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="saveComputationDialog" id="saveComputationDialog" title="节能核算信息"
     style="width:56em;">
    <form id="createSaveComputationForm" method="post" action="/company/add">
        <ul class="nav">
            <li style="margin-bottom: 9px;">
                ...
                <input id="saveComputationDialogAmmeterName" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogProjectName">项目名称:</label>
                <input id="saveComputationDialogProjectName" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogStartDate">开始时间:</label>
                <input id="saveComputationDialogStartDate" dojoType="dijit.form.DateTextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogStartTimeSum">开始累时器值:</label>
                <input id="saveComputationDialogStartTimeSum" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogStartValue">开始电表值:</label>
                <input id="saveComputationDialogStartValue" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEndDate">结束时间:</label>
                <input id="saveComputationDialogEndDate" dojoType="dijit.form.DateTextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEndTimeSum">结束累时器值:</label>
                <input id="saveComputationDialogEndTimeSum" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEndValue">结束电表值:</label>
                <input id="saveComputationDialogEndValue" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogSensorRate">互感器倍率:</label>
                <input id="saveComputationDialogSensorRate" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogRealCost">技改后能耗:</label>
                <input id="saveComputationDialogRealCost" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogFormerCost">技改前能耗:</label>
                <input id="saveComputationDialogFormerCost" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEletricSave">节电量:</label>
                <input id="saveComputationDialogEletricSave" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEletricChargeSave">节电费:</label>
                <input id="saveComputationDialogEletricChargeSave" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogStandardCoalRatio">折算煤系数:</label>
                <input id="saveComputationDialogStandardCoalRatio" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogCoalSave">节约标煤:</label>
                <input id="saveComputationDialogCoalSave" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogEletricCharge">标准电费:</label>
                <input id="saveComputationDialogEletricCharge" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogPartsRatio">成分比率:</label>
                <input id="saveComputationDialogPartsRatio" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogTheOtherPartyBouns">节能公司收益:</label>
                <input id="saveComputationDialogTheOtherPartyBouns" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="saveComputationDialogThePartyBonus">用能公司收益:</label>
                <input id="saveComputationDialogThePartyBonus" data-dojo-type="dijit.form.TextBox"
                       data-dojo-props='name:"readOnlyWidget", readOnly:true, value:"Should be returned"'/>
            </li>
        </ul>
    </form>
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="createCompanyDialog" id="createCompanyDialog" title="添加公司"
     style="width:56em;">
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="createProjectForCompanyDialog" id="createProjectForCompanyDialog"
     title="添加新项目到公司" style="width:56em; ">
        ...
        <ul class="nav">
            ...
            <fieldset id="createOrSelectCompany" class="dijitInline">
                ...
                <li style="margin-bottom: 9px;">
                    ...
                    <input type="radio" id="selectExistingCompanyradio" checked value="full"
            ...
            <li style="margin-bottom: 9px;">
                ...
                <input type="text" id="electricityCharge" class="short" dojoType="dijit.form.ValidationTextBox"
                       trim="true" required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
                       invalidMessage="请输入正确的电费格式 (ex: 5.5)"/>
            </li>

            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="partsRatio">分成比率:</label>
                <input type="text" id="partsRatio" class="short" dojoType="dijit.form.ValidationTextBox" trim="true"
                       required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
                       invalidMessage="请输入正确的比率格式 (ex: 0.5)"/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="ammeterAddedMultiSelect">已经添加的电表:</label><br>
                <select id="ammeterAddedMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                        data-dojo-props='name:"select", style:{height:"15em", width:"22em", border:"5px solid #ededed"}'>
                </select>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="userAddedMultiSelect">已经添加的用户:</label><br>
                <select id="userAddedMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                        data-dojo-props='name:"select", style:{height:"15em", width:"22em", border:"5px solid #ededed"}'>
                </select>
            </li>
        </ul>
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="createAmmeterDialog" id="createAmmeterDialog" title="添加电表"
     style="width:56em;">
    <form id="createAmmeterDialogForm" method="post" action="/ammeter/add">
        <ul class="nav">
            ...
            <li style="margin-bottom: 9px;">
                ...
                <input type="text" id="sensorRate" class="short" dojoType="dijit.form.ValidationTextBox" trim="true"
                       required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
                       invalidMessage="请输入正确的互感器倍率格式 (ex: 5.5)"/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="formerCost">技改前能耗:</label>
                <input type="text" id="formerCost" class="short" dojoType="dijit.form.ValidationTextBox" trim="true"
                       required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
                       invalidMessage="请输入正确的能耗格式 (ex: 5.5)"/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="upperLimit">警报上限:</label>
                <input type="text" id="upperLimit" class="short" dojoType="dijit.form.ValidationTextBox" trim="true"
                       required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
                       invalidMessage="请输入正确的警报上限格式 (ex: 5.5)"/>
            </li>
            <li style="margin-bottom: 9px;">
                <label class="dialogLabel" for="lowerLimit">警报下限:</label>
                <input type="text" id="lowerLimit" class="short" dojoType="dijit.form.ValidationTextBox" trim="true"
                       required="true" regExp="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$|^[1-9]\d*$"
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="createGPRSDialog" id="createGPRSDialog" title="添加电表"
     style="width:56em;">
...
<!-->Create User Dialog</!-->
<div data-dojo-type="dijit.Dialog" data-dojo-id="createUserDialog" id="createUserDialog" title="添加电表"
     style="width:56em;">
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="addUsersToProjectDialog" id="addUsersToProjectDialog">
    ...
    <div class="sel1" role="presentation">
        ...
        <select id="exstingAUsersMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                data-dojo-props='name:"select", style:{height:"20em", width:"22em", border:"5px solid #ededed"}'>
    ...
    <div class="sel2" role="presentation">
        ...
        <select id="addedUsersMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                data-dojo-props='name:"select", style:{height:"20em", width:"22em", border:"5px solid #ededed"}'>
        </select>
    </div>
    <div class="clear"></div>
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="AddExistingAmmeterToProjectDialog"
     id="AddExistingAmmeterToProjectDialog">
    <div>
    ...
    <div class="sel1" role="presentation">
        ...
        <select id="ExstingAmmeterMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                data-dojo-props='name:"select", style:{height:"20em", width:"22em", border:"5px solid #ededed"}'>
            <option class="clone" value="dojo._defaultEasing"></option>
        </select>
    </div>
    ...
    <div class="sel2" role="presentation">
        ...
        <select id="AddedAmmeterMultiSelect" multiple data-dojo-type="dijit.form.MultiSelect"
                data-dojo-props='name:"select", style:{height:"20em", width:"22em", border:"5px solid #ededed"}'>
        </select>
    </div>
    <div class="clear"></div>
...
<div data-dojo-type="dijit.Dialog" data-dojo-id="modifyPasswordDialog" id="modifyPasswordDialog" title="添加电表"
     style="width:56em;">
